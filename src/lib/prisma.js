...
const TRACKED_MODELS = ['Deal', 'Lead', 'Customer', 'Invoice', 'ProspectMeta', 'Campaign', 'User', 'Tenant', 'Activity', 'CustomRole', 'Announcement', 'Attendance', 'LeaveRequest', 'Expense', 'SalaryStructure', 'Payslip'];
